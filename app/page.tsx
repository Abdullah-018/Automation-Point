...
const content = {
  en: {
    ...
    projects: [
      ...
      ['LCW PFL Automation V94', 'Label Layout Automation', 'Detects Regular, CH and Without Country Code content page-by-page and produces precise 25×180 mm or 35×200 mm PFL layouts.'],
      ...
      ['Offset Production Dashboard V70', 'Offset Plate Automation', 'Matches Excel records with front/back PDF artwork, handles EAN barcode variants and builds ordered offset plate and combined production PDFs.'],
      ...
      ['LCW PFL V94 — Backup Build', 'Production Recovery Build', 'Maintained backup of the V94 Regular, CH and Without Country Code layout engine for safe recovery and production continuity.'],
      ['ZARA & LCW UPS Dashboard V32', 'UPS & Combined PDF Production', 'Creates ZARA/PFL and LCW UPS distributions, rebuilds label blocks, preserves barcode quality and outputs print-ready combined PDFs.'],
    ],
  ...
  bn: {
    ...
    projects: [
      ...
      ['LCW PFL Automation V94', 'লেবেল লেআউট অটোমেশন', 'প্রতিটি page-এ Regular, CH ও Without Country Code শনাক্ত করে নির্ভুল 25×180 বা 35×200 mm PFL layout তৈরি করে।'],
      ...
      ['Offset Production Dashboard V70', 'অফসেট প্লেট অটোমেশন', 'Excel record-এর সঙ্গে front/back PDF artwork ও EAN barcode মিলিয়ে সাজানো offset plate ও combined production PDF তৈরি করে।'],
      ...
      ['LCW PFL V94 — Backup Build', 'প্রোডাকশন রিকভারি বিল্ড', 'V94 Regular, CH ও Without Country Code layout engine-এর নিরাপদ recovery ও production continuity backup।'],
      ['ZARA & LCW UPS Dashboard V32', 'UPS ও Combined PDF Production', 'ZARA/PFL ও LCW UPS distribution, label block rebuild, barcode quality preservation এবং print-ready combined PDF তৈরি করে।'],
    ],
  ...
  return (
    <main className={bn ? 'bangla' : ''}>
      ...
      <section className="hero shell"><div className="hero-copy"><p className="eyebrow">{t.hello}</p><h1>{t.heroTitle}</h1><h2>{t.heroRole}</h2><p>{t.heroText}</p><p className="hero-impact">{t.heroImpact}</p><div className="hero-buttons"><a className="btn primary" href="#work">{t.primary} <span>→</span></a><a className="btn secondary" href="#services">{t.secondary} <span>↓</span></a></div><div className="hero-tags"><span>AP Ratio</span><span>Proofing</span><span>Data</span><span>Platforms</span></div></div>
        <div className="hero-art" aria-label="Automation Point leadership"><div className="hero-blob"/><div className="person person-left"><img src="/muhammad-abdullah.jpeg" alt="Muhammad Abdullah, Chief Technology Officer"/></div><div className="person person-right"><img src="/kamruzzaman-zico.jpg" alt="Kamruzzaman Zico, Chief Executive Officer"/></div><div className="tech-card card-one"><b>01</b><span>AUTOMATE</span></div><div className="tech-card card-two"><b>02</b><span>VALIDATE</span></div><div className="dots" aria-hidden="true">••••<br/>••••<br/>••••</div></div>
      </section>
